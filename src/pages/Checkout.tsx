                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-sm">
                        <p className="font-medium text-gray-900">Your payment is secure</p>
                        <p className="text-gray-600">We use industry-standard encryption to protect your information.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
